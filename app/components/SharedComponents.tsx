...
export const getCategoryConfig = (category: unknown) => {
  ...
  if (lowerCat.includes("mobilité") || lowerCat.includes("mobilite")) {
  ...
  return (
      <Pressable style={[styles.card, { width: cardWidth }]} onPress={onPress}>
                  ...
                  <View
                      ...
                      style={[
                        styles.catIconWrapper,
                        {
                          ...
                          zIndex: safeCategories.length - index,
                        },
                      ]}
                  >
        ...
        <Text style={styles.cardTitle} numberOfLines={2}>
          {item.nom || "Défi sans nom"}
        </Text>

        <View style={styles.cardFooter}>
          <Text style={styles.difficultyText}>
            Difficulté : {item.difficulte || 1}/5
          </Text>
